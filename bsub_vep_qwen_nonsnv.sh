#!/bin/bash
#BSUB -J bioreason_vep_qwen_nonsnv
...
#BSUB -W 12:00
#BSUB -o /sc/arion/work/cardia04/BioReason/logs/vep_qwen_nonsnv_%J.out
#BSUB -eo /sc/arion/work/cardia04/BioReason/logs/vep_qwen_nonsnv_%J.err
#BSUB -L /bin/bash
